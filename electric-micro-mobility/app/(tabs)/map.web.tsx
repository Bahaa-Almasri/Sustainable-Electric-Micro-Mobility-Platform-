...
export default function MapScreenWeb() {
  ...
  useEffect(() => {
    console.log('[MapWeb] reserve success modal visibility changed', { visible: reserveSuccessVisible });
  ...
  const onReserveList = useCallback(async (vehicleId: string) => {
    if (!user) return;
    console.log('[MapWeb] reserve button pressed', { vehicleId, userId: user.id });
    setReserveBusyVehicleId(vehicleId);
    console.log('[MapWeb] reserve loading set', {
    ...
    try {
      ...
      console.log('[MapWeb] reservation API success response', { vehicleId, data });
  ...
  const onReserveSuccessOk = useCallback(() => {
    ...
    console.log('[MapWeb] reservation success modal OK pressed');
    console.log('[MapWeb] navigating to reservations route', { route: reservationsRoute });
